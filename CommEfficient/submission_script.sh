...
# do ALL the research
python fed_train.py --momentum_type virtual --error_type virtual --mode sketch --num_clients 100 --num_devices 8 --k 50000 --num_rows 5 --num_cols 1000000 --supervised --static_datasets
