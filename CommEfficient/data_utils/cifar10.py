...
class FedCIFAR10(torch.utils.data.Dataset):
    def __init__(self, dataset_dir, transform=None, do_iid=False,
    ...
    def download_and_split_data(self, dataset_dir):
        ...
        vanilla_CIFAR10_train = datasets.CIFAR10(dataset_dir,
                                                 train=True,
                                                 download=True)
        vanilla_CIFAR10_test = datasets.CIFAR10(dataset_dir,
                                                train=False,
                                                download=True)

        train_images = vanilla_CIFAR10_train.data
        train_targets = np.array(vanilla_CIFAR10_train.targets)
        self.classes = vanilla_CIFAR10_train.classes

        test_images = vanilla_CIFAR10_test.data
        test_targets = np.array(vanilla_CIFAR10_test.targets)
